...
export default function Search(){ 
    ...
    return (
        <div 
            ...
            <div class="w-[56px] h-full flex items-center justify-center absolute top-0 left-0 pointer-events-none">
            ...
            <input 
                type="text" 
                placeholder="Ara" 
                className="w-full h-full bg-transparent placeholder-[#71767b] rounded-full outline-none pl-[3.5rem]"
                value={query} 
            ...
            {focus && (
				<div
					className="absolute w-[350px] translate-y-px top-full -left-px  bg-black shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
