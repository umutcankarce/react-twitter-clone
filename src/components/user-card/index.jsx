    ...
    return (
        <button className="py-3 px-4 flex gap-3 transition-colors hover:bg-white/[0.03]">
                ...
                <div className="flex-1 flex flex-col text-left">
                    <div class="text-[15px] text-[#e7e9ea] leading-5 font-bold flex items-center ">
                        {user.fullName}
                        {user?.verified && (
                            <svg viewBox="0 0 22 22" width={18.75} height={18.75} className="text-[#1d9bf0] ml-0.5"
                            class="r-4qtqp9 r-yyyyoo r-1xvli5t r-bnwqim r-lrvibr r-m6rgpd r-1cvl2hr r-f9ja8p r-og9te1 r-3t4u6i" data-testid="icon-verified">
                ...
                <div>
                    {following ? (
                        <Button size="small" variant="white" className="whitespace-nowrap">
                            Takip ediliyor
                        </Button>
                    ) : (
